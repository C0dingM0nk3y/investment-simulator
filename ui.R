...
ui <- fluidPage(theme = shinytheme("superhero"),
  ...
  fluidRow(align="center",
           ...
           column(3,style="padding:20px",
                  ...
                  div(style="background:#84b0fa55;margin:0px 15px;margin-bottom:15px",
 ...
 fluidRow(align="center",
          column(3,
                 sidebarPanel(width=12,
                    h3("How would have felt, back then?"),
                    h5("aka. Investor Psychology"),
                    br(),
                    p(em("Would you have survived the pressure to sell?"))
                 ),
          ),
          column(6,
                 h4("DCA: investment growth over time"),
